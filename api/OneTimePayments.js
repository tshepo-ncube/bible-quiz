export default class OneTimePayments {
  static async startOneTimePayment(
    senderWalletUrl,
    contribution,
    studentURL,
    studentID,
  ...
  static async finishOneTimePayment(interactRefParam, senderWalletUrl) {
    const data = {
      ...
      msg: "Thanks for donating Lungile, I won't let you down",
    };
